...
export default function OurListingsPage() {
  ...
  // Prepare query params for RTK Query
  const queryParams = {
    page: currentPage,
    limit: itemsPerPage,
    ...
    // potentially add a filter for "our" listings if backend supports it
  };
      ...
      <main className="container py-4 md:py-8 flex-1">
        <div className="mb-4 md:mb-8">
          ...
          <p className="text-muted-foreground text-sm md:text-base">
            Explore our exclusive collection of premium properties in Surrey and
            surrounding areas.
          </p>
        </div>
