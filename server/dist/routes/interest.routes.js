...
router.post("/properties/:id/interest", auth_middleware_1.isAuthenticated, interest_controller_1.createInterest);
router.get("/client/interests", auth_middleware_1.isAuthenticated, interest_controller_1.getClientInterests);
...
router.delete("/interests/:id", auth_middleware_1.isAuthenticated, interest_controller_1.deleteInterest);
