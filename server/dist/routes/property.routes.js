...
router.get("/properties/saved", auth_middleware_1.isClient, property_controller_1.getSavedProperties);
router.post("/properties/wishlist/:id", auth_middleware_1.isClient, property_controller_1.addToWishlist);
router.delete("/properties/wishlist/:id", auth_middleware_1.isClient, property_controller_1.removeFromWishlist);
// Public routes
...
router.post("/properties", auth_middleware_1.isAgent, upload_middleware_1.upload.single("image"), property_controller_1.createProperty);
router.put("/properties/:id", auth_middleware_1.isAgent, upload_middleware_1.upload.single("image"), property_controller_1.updateProperty);
